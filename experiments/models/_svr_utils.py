...
def train_svr(self, train_df: pd.DataFrame, val_df: pd.DataFrame, feature_cols, target_col: str = TARGET_COLUMN, params: dict | None = None):
...
def evaluate(self, model, split_df: pd.DataFrame, feature_cols, target_col: str = TARGET_COLUMN) -> dict[str, float]:
